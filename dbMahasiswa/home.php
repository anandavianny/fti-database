...
<body>
  ...
  <section class="homepage" id="#">
    ...
    <div class="tulisan">
      ...
      <div class="tulisan2">
        Database Mahasiswa <span>Teknik Komputer</span>
      </div>
      <div class="tulisan3">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate
        velit eum quos voluptas voluptates labore assumenda, quidem debitis
        quae, iure ipsam blanditiis illum perspiciatis quisquam minima
        perferendis nisi aperiam sint.
      </div>
      <div class="tombol">
        <a class="submit" href="form_login_regist/formLogin.php">Masuk Sebagai Admin!</a>
      </div>
    </div>
  </section>
